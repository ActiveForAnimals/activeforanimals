...
class FormHelper {
   ...
   */
  public static function validateHiddenField($element, FormStateInterface $form_state) {
    // Make sure it's empty.
    if (!empty($element['#value'])) {
      Drupal::logger(Constant::MODULE_NAME)->notice(Constant::HIDDEN_ELEMENT_NOTICE);
      $form_state->setErrorByName('', t(Constant::FORM_VALIDATION_ERROR_MESSAGE));
    }
  }
   ...
   *   The form state to validate.
   */
  public static function validateShownField($element, FormStateInterface $form_state) {
    // Make sure it's empty.

...
class PagePreprocessor extends Preprocessor implements PreprocessorInterface {
  ...
  public function preprocess() {
    ...
    $this->variables['footer']['facebook_link'] = $element_controller->view(t('Our Facebook page'), 'facebook_link', Url::fromUri('https://www.facebook.com/activeforanimals'));
    $this->variables['footer']['github_logo'] = $image_controller->view($github_logo_path, 'github_logo', NULL, Url::fromUri('https://github.com/ActiveForAnimals/activeforanimals'));
    $this->variables['footer']['github_link'] = $element_controller->view(t('Github repository'), 'facebook_link', Url::fromUri('https://www.facebook.com/activeforanimals'));
